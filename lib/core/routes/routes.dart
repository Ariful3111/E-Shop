...
final List<GetPage> appRoutes = [
    ...
    GetPage(name: AppRoutes.bottomNavigation, page: ()=>BottomNavigation(),binding: MainBindings()),
    GetPage(name: AppRoutes.homeView, page: ()=>HomeView(),bindings: [HomeBindings()]),
    GetPage(name: AppRoutes.storeView, page: ()=>StoreView(),binding: StoreBindings()),
    GetPage(name: AppRoutes.wishlistView, page: ()=>WishlistView(),binding: WishlistBindings()),
    GetPage(name: AppRoutes.profileView, page: ()=>ProfileView(),binding: ProfileBindings()),
];
